...
import img1 from "../../../assets/imgs/pages/WB_Right_3/Right Int WB G3 U8 Folder/Page 45/SVG/Asset 92.svg";
import img2 from "../../../assets/imgs/pages/WB_Right_3/Right Int WB G3 U8 Folder/Page 45/SVG/Asset 93.svg";
import img3 from "../../../assets/imgs/pages/WB_Right_3/Right Int WB G3 U8 Folder/Page 45/SVG/Asset 94.svg";
import img4 from "../../../assets/imgs/pages/WB_Right_3/Right Int WB G3 U8 Folder/Page 45/SVG/Asset 95.svg";
import img5 from "../../../assets/imgs/pages/WB_Right_3/Right Int WB G3 U8 Folder/Page 45/SVG/Asset 96.svg";
import img6 from "../../../assets/imgs/pages/WB_Right_3/Right Int WB G3 U8 Folder/Page 45/SVG/Asset 97.svg";
import img7 from "../../../assets/imgs/pages/WB_Right_3/Right Int WB G3 U8 Folder/Page 45/SVG/Asset 98.svg";
...
export default function WB_Unit8_Page45_QA() {
  ...
  const handleCheck = () => {
    ...
    if (!allAnswered) {
      ValidationAlert.info("Please complete all words first! ✏️");
      return;
    }

    let correct = 0;
    ITEMS.forEach((item) => {
      if (isRowCorrect(item)) correct++;
    });
    setChecked(true);
    setShowAns(false);
                ...
                <div style={{ display: "flex", flexWrap: "wrap", gap: "3px" }}>
                  {item.pairs.map((pair, index) => (
                    <DiagonalCell
                      ...
                      onSelectBottom={() =>
                        handleSelect(item.id, index, "bottom")
                      }
                    />
                  ))}
                </div>
